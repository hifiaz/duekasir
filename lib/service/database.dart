...
//   Future<void> updateUser(Users val) async {
//     final isar = await db;
...
//     final isar = await db;
//     IsarCollection<Users> userCollection = isar.collection<Users>();
...
//     final isar = await db;
//     IsarCollection<Customer> customerCollection = isar.collection<Customer>();
...
//   Future<void> updateInventory(Inventory val) async {
//     final isar = await db;
...
//   Future<List<Inventory>> getInventorys({String? value}) async {
//     final isar = await db;
//     IsarCollection<Inventory> inventoryCollection =
//         isar.collection<Inventory>();
...
//   insertInventoryFresh(List<Inventory> inventoryList) async {
//     final isar = await db;
...
//   void updateInventorySync(Inventory inventory) async {
//     final isar = await db;
...
//       List<Inventory> unsyncedInventory = await getUnsyncedInventoryData();
...
//     final isar = await db;
//     IsarCollection<Report> reportCollection =
//         isar.collection<Report>();
//     if (isDeviceConnected.value && supabase.auth.currentUser != null) {
...
//       {required DateTime start, required DateTime end}) async {
//     final isar = await db;
//     IsarCollection<Report> inventoryCollection =
//         isar.collection<Report>();
...
//     final Map<DateTime, List<Report>> listOfOrders = items.groupListsBy(
//         (order) => DateTime(
...
//     final isar = await db;
//     IsarCollection<Store> storeCollection = isar.collection<Store>();
...
//   // presense
//   Future<void> addPresense(PresenseModel val) async {
//     val.isSynced = isDeviceConnected.value && supabase.auth.currentUser != null;
//     final isar = await db;
...
//       {required DateTime start, required DateTime end}) async {
//     final isar = await db;
//     IsarCollection<PresenseModel> presenseCollection = isar.collection<Presence>();
...
//   // rent item
//   Future<void> addRentItem(RentItems val) async {
//     val.isSynced = isDeviceConnected.value && supabase.auth.currentUser != null;
//     final isar = await db;
...
//   Future<List<RentItems>> getRentItem() async {
//     final isar = await db;
...
//   Future<void> updateRent(Rent val) async {
//     final isar = await db;
...
//       {required DateTime start, required DateTime end}) async {
//     final isar = await db;
//     IsarCollection<Expenses> expensesCollection = isar.collection<Expenses>();
...
//   // Salary
//   Future<void> addSalary(Salary val) async {
//     val.isSynced = isDeviceConnected.value && supabase.auth.currentUser != null;
//     final isar = await db;
...
//   Future<void> updateSalary(Salary val) async {
//     final isar = await db;
...
//   Future<List<DuePayment>> getDuePayments({String? value}) async {
//     final isar = await db;
